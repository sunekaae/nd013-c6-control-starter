    ...
    def move(self, sim_time, res=1):
        ...
        for i in range(len(spirals_x)):
            ...
            for index in range(1, len(spirals_x[i])):
                ...
                self.world.debug.draw_line(start.location, end.location, 0.1, color, 1.0)
        ...
        for index in range(res, len(way_points), res):
            ...
            self.world.debug.draw_line(start.location, end.location, 0.1, carla.Color(r=125, g=125, b=0), 1.0)
            previous_index = index
